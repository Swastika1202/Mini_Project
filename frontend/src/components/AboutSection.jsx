        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Phantom Finance is built to empower young adults to take control of
              their financial lives with confidence and clarity. Simple tools,
              practical lessons, and smart strategies—all in one platform.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            ...
            <div className="text-center space-y-4 group">
              ...
              <p className="text-muted-foreground">
                Designed with students and young adults in mind.
              </p>
            </div>
            ...
            <div className="text-center space-y-4 group">
              ...
              <p className="text-muted-foreground">
                AI-powered tips to help you make better financial decisions.
              </p>
            </div>
          </div>
        </div>
