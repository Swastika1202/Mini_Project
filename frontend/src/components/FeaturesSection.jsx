...
const features = [
  {
    ...
    description:
      "Create personalized budgets that adapt to your lifestyle and financial goals.",
  ...
  },
  {
    ...
    description:
      "Track every dollar with intuitive categorization and real-time insights.",
  ...
  },
  {
    ...
    title: "Savings Goals",
    description:
      "Set and achieve savings targets with smart progress tracking and reminders.",
    color: "text-accent",
  ...
  },
  {
    ...
    description:
      "Learn money management with curated content designed for young adults.",
  ...
  },
  {
    ...
    description:
      "Simple, intuitive interface that makes YouthWallet accessible to everyone.",
    color: "text-finance-teal",
    bgColor: "bg-finance-teal/10",
  },
];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`${feature.bgColor} ${feature.color} w-14 h-14 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}
                >
